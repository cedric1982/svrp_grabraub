...
Config.Texts = {
    Prompt1 = "Graben",
    Prompt2 = "Beten",
    GraveRobbery = "Grab Plündern",
    GraveDisplay = "Grab:",
    CantDoThat = "Du kannst das jetzt nicht machen!",
    GraveRobbed = "Das Grab wurde schon geplündert!",
    NoShovel = "Du hast keine Schaufel!",
    FoundItem = "Du hast etwas gefunden!",
}
